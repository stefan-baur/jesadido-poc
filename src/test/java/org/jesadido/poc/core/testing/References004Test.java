...
public class References004Test {
    ...
    public void testVerticalTranslation005Game20160930023201MESZ() {
        ...
        Assert.assertEquals("{ Su ( La LudO ) Dom ( HavAs ) Fin ( Vi$La HeroIcxO SanA ) } .", TranslatorFactory.createTranslator(Language.JI, References.GAME_BOOK).translate(source).getTranslation());
        Assert.assertEquals("Das Spiel hat euren gesunden Helden.", TranslatorFactory.createTranslator(Language.DE, References.GAME_BOOK).translate(source).getTranslation());
        Assert.assertEquals("The game has your sane hero.", TranslatorFactory.createTranslator(Language.EN, References.GAME_BOOK).translate(source).getTranslation());
        Assert.assertEquals("La ludo havas vian sanan heroon.", TranslatorFactory.createTranslator(Language.EO, References.GAME_BOOK).translate(source).getTranslation());
        Assert.assertEquals("El juego tiene vuestro héroe sano.", TranslatorFactory.createTranslator(Language.ES, References.GAME_BOOK).translate(source).getTranslation());
        Assert.assertEquals("Le jeu a votre héros sain.", TranslatorFactory.createTranslator(Language.FR, References.GAME_BOOK).translate(source).getTranslation());
    }
    ...
    public void testVerticalTranslation011Game20160930023201MESZ() {
        ...
        Assert.assertEquals("{ Su ( Mi$La HeroIcxO ) Dom ( TrovAs ) Fin ( La SkribIlO GigantA KontentA ) } .", TranslatorFactory.createTranslator(Language.JI, References.GAME_BOOK).translate(source).getTranslation());
        Assert.assertEquals("Mein Held findet den gigantischen und zufriedenen Stift.", TranslatorFactory.createTranslator(Language.DE, References.GAME_BOOK).translate(source).getTranslation());
        Assert.assertEquals("My hero finds the gigantic and satisfied pen.", TranslatorFactory.createTranslator(Language.EN, References.GAME_BOOK).translate(source).getTranslation());
        Assert.assertEquals("Mia heroo trovas la gigantan kaj kontentan skribilon.", TranslatorFactory.createTranslator(Language.EO, References.GAME_BOOK).translate(source).getTranslation());
        Assert.assertEquals("Mi héroe encuentra el gigantesco lapicero satisfecho.", TranslatorFactory.createTranslator(Language.ES, References.GAME_BOOK).translate(source).getTranslation());
        Assert.assertEquals("Mon héros trouve le gigantesque crayon satisfait.", TranslatorFactory.createTranslator(Language.FR, References.GAME_BOOK).translate(source).getTranslation());
    }
    ...
    public void testVerticalTranslation017Game20160930023201MESZ() {
        ...
        Assert.assertEquals("{ Su ( Vi$La HeroIcxO SanA KontentA GigantA ) Dom ( TrovAs ) Fin ( FlorO ) } .", TranslatorFactory.createTranslator(Language.JI, References.GAME_BOOK).translate(source).getTranslation());
        Assert.assertEquals("Euer gesunder, zufriedener und gigantischer Held findet eine Blume.", TranslatorFactory.createTranslator(Language.DE, References.GAME_BOOK).translate(source).getTranslation());
        Assert.assertEquals("Your sane, satisfied and gigantic hero finds a flower.", TranslatorFactory.createTranslator(Language.EN, References.GAME_BOOK).translate(source).getTranslation());
        Assert.assertEquals("Via sana, kontenta kaj giganta heroo trovas floron.", TranslatorFactory.createTranslator(Language.EO, References.GAME_BOOK).translate(source).getTranslation());
        Assert.assertEquals("Vuestro gigantesco héroe sano y satisfecho encuentra una flor.", TranslatorFactory.createTranslator(Language.ES, References.GAME_BOOK).translate(source).getTranslation());
        Assert.assertEquals("Votre gigantesque héros sain et satisfait trouve une fleur.", TranslatorFactory.createTranslator(Language.FR, References.GAME_BOOK).translate(source).getTranslation());
    }
    ...
    public void testVerticalTranslation023Game20160930023201MESZ() {
        ...
        Assert.assertEquals("{ Su ( La HeroInO GigantA KontentA ) Dom ( TrovAs ) Fin ( LudO$Gxi$La SkribIlO GigantA ) } .", TranslatorFactory.createTranslator(Language.JI, References.GAME_BOOK).translate(source).getTranslation());
        Assert.assertEquals("Die gigantische und zufriedene Heldin findet seinen gigantischen Stift.", TranslatorFactory.createTranslator(Language.DE, References.GAME_BOOK).translate(source).getTranslation());
        Assert.assertEquals("The gigantic and satisfied heroine finds its gigantic pen.", TranslatorFactory.createTranslator(Language.EN, References.GAME_BOOK).translate(source).getTranslation());
        Assert.assertEquals("La giganta kaj kontenta heroino trovas ĝian gigantan skribilon.", TranslatorFactory.createTranslator(Language.EO, References.GAME_BOOK).translate(source).getTranslation());
        Assert.assertEquals("La gigantesca heroína satisfecha encuentra su gigantesco lapicero.", TranslatorFactory.createTranslator(Language.ES, References.GAME_BOOK).translate(source).getTranslation());
        Assert.assertEquals("La gigantesque héroïne satisfaite trouve son gigantesque crayon.", TranslatorFactory.createTranslator(Language.FR, References.GAME_BOOK).translate(source).getTranslation());
    }
    ...
    public void testVerticalTranslation029Game20160930023201MESZ() {
        ...
        Assert.assertEquals("Kaj { Su ( HeroInO AtentA KontentA ) Dom ( TrovAs ) Fin ( InArO$Vi$La FlorO GigantA SanA ) } .", TranslatorFactory.createTranslator(Language.JI, References.GAME_BOOK).translate(source).getTranslation());
        Assert.assertEquals("Und eine aufmerksame und zufriedene Heldin findet eure gigantische und gesunde Blume.", TranslatorFactory.createTranslator(Language.DE, References.GAME_BOOK).translate(source).getTranslation());
        Assert.assertEquals("And an attentive and satisfied heroine finds your gigantic and sane flower.", TranslatorFactory.createTranslator(Language.EN, References.GAME_BOOK).translate(source).getTranslation());
        Assert.assertEquals("Kaj atenta kaj kontenta heroino trovas vian gigantan kaj sanan floron.", TranslatorFactory.createTranslator(Language.EO, References.GAME_BOOK).translate(source).getTranslation());
        Assert.assertEquals("Y una heroína atenta y satisfecha encuentra vuestra gigantesca flor sana.", TranslatorFactory.createTranslator(Language.ES, References.GAME_BOOK).translate(source).getTranslation());
        Assert.assertEquals("Et une héroïne attentive et satisfaite trouve votre gigantesque fleur saine.", TranslatorFactory.createTranslator(Language.FR, References.GAME_BOOK).translate(source).getTranslation());
    }
    ...
    public void testVerticalTranslation035Game20160930023201MESZ() {
        ...
        Assert.assertEquals("{ Su ( IcxO$Mi$La HeroIcxO KontentA ) Dom ( HavAs ) Fin ( NomO GigantA ) } .", TranslatorFactory.createTranslator(Language.JI, References.GAME_BOOK).translate(source).getTranslation());
        Assert.assertEquals("Mein zufriedener Held hat einen gigantischen Namen.", TranslatorFactory.createTranslator(Language.DE, References.GAME_BOOK).translate(source).getTranslation());
        Assert.assertEquals("My satisfied hero has a gigantic name.", TranslatorFactory.createTranslator(Language.EN, References.GAME_BOOK).translate(source).getTranslation());
        Assert.assertEquals("Mia kontenta heroo havas gigantan nomon.", TranslatorFactory.createTranslator(Language.EO, References.GAME_BOOK).translate(source).getTranslation());
        Assert.assertEquals("Mi héroe satisfecho tiene un gigantesco nombre.", TranslatorFactory.createTranslator(Language.ES, References.GAME_BOOK).translate(source).getTranslation());
        Assert.assertEquals("Mon héros satisfait a un gigantesque nom.", TranslatorFactory.createTranslator(Language.FR, References.GAME_BOOK).translate(source).getTranslation());
    }
    ...
    public void testVerticalTranslation041Game20160930023201MESZ() {
        ...
        Assert.assertEquals("{ Su ( HeroIcxO KontentA KuragxA ) Dom ( DonAs ) Al ( La HeroInO SanA ) Fin ( SkribIlO ) } .", TranslatorFactory.createTranslator(Language.JI, References.GAME_BOOK).translate(source).getTranslation());
        Assert.assertEquals("Ein zufriedener und beherzter Held gibt der gesunden Heldin einen Stift.", TranslatorFactory.createTranslator(Language.DE, References.GAME_BOOK).translate(source).getTranslation());
        Assert.assertEquals("A satisfied and valiant hero gives the sane heroine a pen.", TranslatorFactory.createTranslator(Language.EN, References.GAME_BOOK).translate(source).getTranslation());
        Assert.assertEquals("Kontenta kaj kuraĝa heroo donas al la sana heroino skribilon.", TranslatorFactory.createTranslator(Language.EO, References.GAME_BOOK).translate(source).getTranslation());
        Assert.assertEquals("Un héroe satisfecho y valiente da a la heroína sana un lapicero.", TranslatorFactory.createTranslator(Language.ES, References.GAME_BOOK).translate(source).getTranslation());
        Assert.assertEquals("Un héros satisfait et courageux donne à l'héroïne saine un crayon.", TranslatorFactory.createTranslator(Language.FR, References.GAME_BOOK).translate(source).getTranslation());
    }
    ...
    public void testVerticalTranslation047Game20160930023201MESZ() {
        ...
        Assert.assertEquals("{ Su ( HeroIcxO GigantA ) Dom ( DonAs ) Al ( HeroInO ) Fin ( HomArO$Ni$La FlorO GigantA ) } .", TranslatorFactory.createTranslator(Language.JI, References.GAME_BOOK).translate(source).getTranslation());
        Assert.assertEquals("Ein gigantischer Held gibt einer Heldin unsere gigantische Blume.", TranslatorFactory.createTranslator(Language.DE, References.GAME_BOOK).translate(source).getTranslation());
        Assert.assertEquals("A gigantic hero gives a heroine our gigantic flower.", TranslatorFactory.createTranslator(Language.EN, References.GAME_BOOK).translate(source).getTranslation());
        Assert.assertEquals("Giganta heroo donas al heroino nian gigantan floron.", TranslatorFactory.createTranslator(Language.EO, References.GAME_BOOK).translate(source).getTranslation());
        Assert.assertEquals("Un gigantesco héroe da a una heroína nuestra gigantesca flor.", TranslatorFactory.createTranslator(Language.ES, References.GAME_BOOK).translate(source).getTranslation());
        Assert.assertEquals("Un gigantesque héros donne à une héroïne notre gigantesque fleur.", TranslatorFactory.createTranslator(Language.FR, References.GAME_BOOK).translate(source).getTranslation());
    }
    ...
    public void testVerticalTranslation053Game20160930023201MESZ() {
        ...
        Assert.assertEquals("{ Su ( HeroInO GigantA AtentA ) Dom ( DonAs ) Al ( La HeroIcxO GigantA KontentA ) Fin ( Bi$La SkribIlO GigantA ) } .", TranslatorFactory.createTranslator(Language.JI, References.GAME_BOOK).translate(source).getTranslation());
        Assert.assertEquals("Eine gigantische und aufmerksame Heldin gibt dem gigantischen und zufriedenen Helden deinen gigantischen Stift.", TranslatorFactory.createTranslator(Language.DE, References.GAME_BOOK).translate(source).getTranslation());
        Assert.assertEquals("A gigantic and attentive heroine gives the gigantic and satisfied hero your gigantic pen.", TranslatorFactory.createTranslator(Language.EN, References.GAME_BOOK).translate(source).getTranslation());
        Assert.assertEquals("Giganta kaj atenta heroino donas al la giganta kaj kontenta heroo vian gigantan skribilon.", TranslatorFactory.createTranslator(Language.EO, References.GAME_BOOK).translate(source).getTranslation());
        Assert.assertEquals("Una gigantesca heroína atenta da al gigantesco héroe satisfecho tu gigantesco lapicero.", TranslatorFactory.createTranslator(Language.ES, References.GAME_BOOK).translate(source).getTranslation());
        Assert.assertEquals("Une gigantesque héroïne attentive donne à le gigantesque héros satisfait ton gigantesque crayon.", TranslatorFactory.createTranslator(Language.FR, References.GAME_BOOK).translate(source).getTranslation());
    }
    ...
    public void testVerticalTranslation059Game20160930023201MESZ() {
        ...
        Assert.assertEquals("Kaj { Su ( La HeroInO SanA AtentA KuragxA ) Dom ( DonAs ) Al ( HeroIcxO KontentA ) Fin ( HeroInArO$Ili$La FlorO ) } .", TranslatorFactory.createTranslator(Language.JI, References.GAME_BOOK).translate(source).getTranslation());
        Assert.assertEquals("Und die gesunde, aufmerksame und beherzte Heldin gibt einem zufriedenen Helden ihre Blume.", TranslatorFactory.createTranslator(Language.DE, References.GAME_BOOK).translate(source).getTranslation());
        Assert.assertEquals("And the sane, attentive and valiant heroine gives a satisfied hero their flower.", TranslatorFactory.createTranslator(Language.EN, References.GAME_BOOK).translate(source).getTranslation());
        Assert.assertEquals("Kaj la sana, atenta kaj kuraĝa heroino donas al kontenta heroo ilian floron.", TranslatorFactory.createTranslator(Language.EO, References.GAME_BOOK).translate(source).getTranslation());
        Assert.assertEquals("Y la heroína sana, atenta y valiente da a un héroe satisfecho su flor.", TranslatorFactory.createTranslator(Language.ES, References.GAME_BOOK).translate(source).getTranslation());
        Assert.assertEquals("Et l'héroïne saine, attentive et courageuse donne à un héros satisfait leur fleur.", TranslatorFactory.createTranslator(Language.FR, References.GAME_BOOK).translate(source).getTranslation());
    }
    ...
    public void testVerticalTranslation065Game20160930023201MESZ() {
        ...
        Assert.assertEquals("L'héros satisfait trouve une gigantesque fleur et votre héroïne trouve un gigantesque crayon.", TranslatorFactory.createTranslator(Language.FR, References.GAME_BOOK).translate(source).getTranslation());
    }
    ...
    public void testVerticalTranslation071Game20160930023201MESZ() {
        ...
        Assert.assertEquals("{ Su ( Bi$La HeroIcxO KontentA AtentA ) Dom ( DonAs ) Al ( HeroInO MalSanA KontentA ) Fin ( La FlorO ) } Kaj { Su ( HeroInO MalSanA ) Dom ( DonAs ) Al ( HeroIcxO ) Fin ( SkribIlO ) } .", TranslatorFactory.createTranslator(Language.JI, References.GAME_BOOK).translate(source).getTranslation());
        Assert.assertEquals("Dein zufriedener und aufmerksamer Held gibt einer kranken und zufriedenen Heldin die Blume, und eine kranke Heldin gibt einem Helden einen Stift.", TranslatorFactory.createTranslator(Language.DE, References.GAME_BOOK).translate(source).getTranslation());
        Assert.assertEquals("Your satisfied and attentive hero gives a sick and satisfied heroine the flower, and a sick heroine gives a hero a pen.", TranslatorFactory.createTranslator(Language.EN, References.GAME_BOOK).translate(source).getTranslation());
        Assert.assertEquals("Via kontenta kaj atenta heroo donas al sana kaj kontenta heroino la floron, kaj sana heroino donas al heroo skribilon.", TranslatorFactory.createTranslator(Language.EO, References.GAME_BOOK).translate(source).getTranslation());
        Assert.assertEquals("Tu héroe satisfecho y atento da a una heroína enferma y satisfecha la flor, y una heroína enferma da a un héroe un lapicero.", TranslatorFactory.createTranslator(Language.ES, References.GAME_BOOK).translate(source).getTranslation());
        Assert.assertEquals("Ton héros satisfait et attentif donne à une héroïne malade et satisfaite la fleur et une héroïne malade donne à un héros un crayon.", TranslatorFactory.createTranslator(Language.FR, References.GAME_BOOK).translate(source).getTranslation());
    }
    ...
    public void testVerticalTranslation077Game20160930023201MESZ() {
        ...
        Assert.assertEquals("{ Su ( HeroIcxO SanA ) Dom ( DonAs ) Al ( Ni$La HeroInO ) Fin ( FlorO ) } Aux { Su ( La HeroInO KontentA KuragxA ) Dom ( DonAs ) Al ( HeroIcxO ) Fin ( SkribIlO ) } .", TranslatorFactory.createTranslator(Language.JI, References.GAME_BOOK).translate(source).getTranslation());
        Assert.assertEquals("Ein gesunder Held gibt unserer Heldin eine Blume, oder die zufriedene und beherzte Heldin gibt einem Helden einen Stift.", TranslatorFactory.createTranslator(Language.DE, References.GAME_BOOK).translate(source).getTranslation());
        Assert.assertEquals("A sane hero gives our heroine a flower, or the satisfied and valiant heroine gives a hero a pen.", TranslatorFactory.createTranslator(Language.EN, References.GAME_BOOK).translate(source).getTranslation());
        Assert.assertEquals("Sana heroo donas al nia heroino floron, aŭ la kontenta kaj kuraĝa heroino donas al heroo skribilon.", TranslatorFactory.createTranslator(Language.EO, References.GAME_BOOK).translate(source).getTranslation());
        Assert.assertEquals("Un héroe sano da a nuestra heroína una flor, o la heroína satisfecha y valiente da a un héroe un lapicero.", TranslatorFactory.createTranslator(Language.ES, References.GAME_BOOK).translate(source).getTranslation());
        Assert.assertEquals("Un héros sain donne à notre héroïne une fleur ou l'héroïne satisfaite et courageuse donne à un héros un crayon.", TranslatorFactory.createTranslator(Language.FR, References.GAME_BOOK).translate(source).getTranslation());
    }
    ...
    public void testVerticalTranslation083Game20160930023201MESZ() {
        ...
        Assert.assertEquals("{ Fin ( SkribIlO ) Su ( Vi$La HeroIcxO SanA ) Dom ( TrovAs ) } . { Fin ( NomO GigantA KontentA ) Al ( Mi$La HeroIcxO ) Dom ( DonAs ) Su ( La HeroInO ) } .", TranslatorFactory.createTranslator(Language.JI, References.GAME_BOOK).translate(source).getTranslation());
        Assert.assertEquals("Einen Stift findet euer gesunder Held. Einen gigantischen und zufriedenen Namen gibt die Heldin meinem Helden.", TranslatorFactory.createTranslator(Language.DE, References.GAME_BOOK).translate(source).getTranslation());
        Assert.assertEquals("Your sane hero finds a pen. The heroine gives my hero a gigantic and satisfied name.", TranslatorFactory.createTranslator(Language.EN, References.GAME_BOOK).translate(source).getTranslation());
        Assert.assertEquals("Skribilon via sana heroo trovas. Gigantan kaj kontentan nomon al mia heroo donas la heroino.", TranslatorFactory.createTranslator(Language.EO, References.GAME_BOOK).translate(source).getTranslation());
        Assert.assertEquals("Vuestro héroe sano encuentra un lapicero. La heroína da a mi héroe un gigantesco nombre satisfecho.", TranslatorFactory.createTranslator(Language.ES, References.GAME_BOOK).translate(source).getTranslation());
        Assert.assertEquals("Votre héros sain trouve un crayon. L'héroïne donne à mon héros un gigantesque nom satisfait.", TranslatorFactory.createTranslator(Language.FR, References.GAME_BOOK).translate(source).getTranslation());
    }
    ...
    public void testVerticalTranslation089Game20160930023201MESZ() {
        ...
        Assert.assertEquals("{ Fin ( Bi$La SkribIlO GigantA AtentA ) Dom ( TrovAs ) Su ( HeroIcxO SanA ) } Kaj { Dom ( TrovAs ) Fin ( FlorO ) Su ( Ni$La HeroInO ) } Kaj { Al ( La HeroIcxO ) Fin ( FlorO GigantA ) Dom ( DonAs ) Su ( Bi$La HeroInO ) } .", TranslatorFactory.createTranslator(Language.JI, References.GAME_BOOK).translate(source).getTranslation());
        Assert.assertEquals("Deinen gigantischen und aufmerksamen Stift findet ein gesunder Held, und eine Blume findet unsere Heldin, und eine gigantische Blume gibt deine Heldin dem Helden.", TranslatorFactory.createTranslator(Language.DE, References.GAME_BOOK).translate(source).getTranslation());
        Assert.assertEquals("A sane hero finds your gigantic and attentive pen, and our heroine finds a flower, and your heroine gives the hero a gigantic flower.", TranslatorFactory.createTranslator(Language.EN, References.GAME_BOOK).translate(source).getTranslation());
        Assert.assertEquals("Vian gigantan kaj atentan skribilon trovas sana heroo, kaj trovas floron nia heroino, kaj al la heroo gigantan floron donas via heroino.", TranslatorFactory.createTranslator(Language.EO, References.GAME_BOOK).translate(source).getTranslation());
        Assert.assertEquals("Un héroe sano encuentra tu gigantesco lapicero atento, y nuestra heroína encuentra una flor, y tu heroína da al héroe una gigantesca flor.", TranslatorFactory.createTranslator(Language.ES, References.GAME_BOOK).translate(source).getTranslation());
        Assert.assertEquals("Un héros sain trouve ton gigantesque crayon attentif et notre héroïne trouve une fleur et t'héroïne donne à l'héros une gigantesque fleur.", TranslatorFactory.createTranslator(Language.FR, References.GAME_BOOK).translate(source).getTranslation());
    }
    ...
    public void testVerticalTranslation095Game20160930023201MESZ() {
        ...
        Assert.assertEquals("{ Fin ( La SkribIlO ) Dom ( TrovAs ) Su ( HeroIcxO GigantA ) } , { Dom ( TrovAs ) Fin ( FlorO ) Su ( Ni$La HeroInO GigantA ) } , { Al ( HeroIcxO GigantA ) Fin ( Mi$La FlorO ) Dom ( DonAs ) Su ( Bi$La HeroInO GigantA ) } .", TranslatorFactory.createTranslator(Language.JI, References.GAME_BOOK).translate(source).getTranslation());
        Assert.assertEquals("Den Stift findet ein gigantischer Held, eine Blume findet unsere gigantische Heldin, meine Blume gibt deine gigantische Heldin einem gigantischen Helden.", TranslatorFactory.createTranslator(Language.DE, References.GAME_BOOK).translate(source).getTranslation());
        Assert.assertEquals("A gigantic hero finds the pen, our gigantic heroine finds a flower, your gigantic heroine gives a gigantic hero my flower.", TranslatorFactory.createTranslator(Language.EN, References.GAME_BOOK).translate(source).getTranslation());
        Assert.assertEquals("La skribilon trovas giganta heroo, trovas floron nia giganta heroino, al giganta heroo mian floron donas via giganta heroino.", TranslatorFactory.createTranslator(Language.EO, References.GAME_BOOK).translate(source).getTranslation());
        Assert.assertEquals("Un gigantesco héroe encuentra el lapicero, nuestra gigantesca heroína encuentra una flor, tu gigantesca heroína da a un gigantesco héroe mi flor.", TranslatorFactory.createTranslator(Language.ES, References.GAME_BOOK).translate(source).getTranslation());
        Assert.assertEquals("Un gigantesque héros trouve le crayon, notre gigantesque héroïne trouve une fleur, ta gigantesque héroïne donne à un gigantesque héros ma fleur.", TranslatorFactory.createTranslator(Language.FR, References.GAME_BOOK).translate(source).getTranslation());
    }
    ...
    public void testVerticalTranslation101Game20160930023201MESZ() {
        ...
        Assert.assertEquals("L'héros satisfait et sain trouve un crayon. Un héros sain et satisfait a leur crayon.", TranslatorFactory.createTranslator(Language.FR, References.GAME_BOOK).translate(source).getTranslation());
    }
    ...
    public void testVerticalTranslation107Game20160930023201MESZ() {
        ...
        Assert.assertEquals("Se { Su ( Mi$La HeroIcxO GigantA ) Dom ( TrovAs ) Fin ( La FlorO SanA ) } , { Su ( HeroIcxO GigantA KontentA SanA ) Dom ( DonAs ) Fin ( FlorO SanA ) Al ( HeroInO ) } .", TranslatorFactory.createTranslator(Language.JI, References.GAME_BOOK).translate(source).getTranslation());
        Assert.assertEquals("Wenn mein gigantischer Held die gesunde Blume findet, gibt ein gigantischer, zufriedener und gesunder Held einer Heldin eine gesunde Blume.", TranslatorFactory.createTranslator(Language.DE, References.GAME_BOOK).translate(source).getTranslation());
        Assert.assertEquals("If my gigantic hero finds the sane flower, a gigantic, satisfied and sane hero gives a heroine a sane flower.", TranslatorFactory.createTranslator(Language.EN, References.GAME_BOOK).translate(source).getTranslation());
        Assert.assertEquals("Se mia giganta heroo trovas la sanan floron, giganta, kontenta kaj sana heroo donas sanan floron al heroino.", TranslatorFactory.createTranslator(Language.EO, References.GAME_BOOK).translate(source).getTranslation());
        Assert.assertEquals("Si mi gigantesco héroe encuentra la flor sana, un gigantesco héroe satisfecho y sano da a una heroína una flor sana.", TranslatorFactory.createTranslator(Language.ES, References.GAME_BOOK).translate(source).getTranslation());
        Assert.assertEquals("Si mon gigantesque héros trouve la fleur saine, un gigantesque héros satisfait et sain donne à une héroïne une fleur saine.", TranslatorFactory.createTranslator(Language.FR, References.GAME_BOOK).translate(source).getTranslation());
    }
    ...
    public void testVerticalTranslation113Game20160930023201MESZ() {
        ...
        Assert.assertEquals("Votre gigantesque héros satisfait et courageux donne à m'héroïne une fleur, si l'héros satisfait trouve une fleur.", TranslatorFactory.createTranslator(Language.FR, References.GAME_BOOK).translate(source).getTranslation());
    }
}
