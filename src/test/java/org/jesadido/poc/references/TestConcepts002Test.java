...
public class TestConcepts002Test {
    ...
    public void testVerticalTranslation039Game20160929022234MESZ() {
        ...
        Assert.assertEquals("El héroe encuentra una flor, y tu heroína encuentra un lápiz.", TranslatorFactory.createTranslator(Language.ES, ReferenceConceptBooks.TEST_CONCEPTS).translate(source).getTranslation());
    ...
    public void testVerticalTranslation047Game20160929022234MESZ() {
        ...
        Assert.assertEquals("Un héroe da a mi heroína una flor, o la heroína da a un héroe un lápiz.", TranslatorFactory.createTranslator(Language.ES, ReferenceConceptBooks.TEST_CONCEPTS).translate(source).getTranslation());
    ...
    public void testVerticalTranslation051Game20160929022234MESZ() {
        ...
        Assert.assertEquals("Tu héroe encuentra un lápiz. La heroína da a mi héroe un nombre.", TranslatorFactory.createTranslator(Language.ES, ReferenceConceptBooks.TEST_CONCEPTS).translate(source).getTranslation());
    ...
    public void testVerticalTranslation055Game20160929022234MESZ() {
        ...
        Assert.assertEquals("Un héroe encuentra tu lápiz, y mi heroína encuentra una flor, y tu heroína da al héroe una flor.", TranslatorFactory.createTranslator(Language.ES, ReferenceConceptBooks.TEST_CONCEPTS).translate(source).getTranslation());
    ...
    public void testVerticalTranslation059Game20160929022234MESZ() {
        ...
        Assert.assertEquals("Un héroe encuentra el lápiz, mi heroína encuentra una flor, tu heroína da a un héroe mi flor.", TranslatorFactory.createTranslator(Language.ES, ReferenceConceptBooks.TEST_CONCEPTS).translate(source).getTranslation());
    ...
    public void testVerticalTranslation063Game20160929022234MESZ() {
        ...
        Assert.assertEquals("El héroe encuentra un lápiz. Un héroe tiene tu lápiz.", TranslatorFactory.createTranslator(Language.ES, ReferenceConceptBooks.TEST_CONCEPTS).translate(source).getTranslation());
