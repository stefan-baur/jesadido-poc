...
public final class ThingFactory {
    ...
    public static Thing createSunO() {
        return new Thing("SunO", new RagScale(0.25).add(new RagPath(RgboKeys.YELLOW, "M 165.95838,36.619147 C 246.32588,94.694301 162.33828,207.16726 69.749939,153.1273 -22.838399,99.087344 85.590876,-21.456007 165.95838,36.619147 z")));
    }
