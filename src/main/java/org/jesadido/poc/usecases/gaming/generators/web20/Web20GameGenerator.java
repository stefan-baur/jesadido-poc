...
public class Web20GameGenerator {
    ...
    private void generateComponentCssFile() throws IOException {
        ...
        new Src()
                ...
                .end("}")
                .line()
                .begin(".game-master .languages {")
                .line(cssDisplayInlineBlock)
                .line("margin-left: 20px;")
                .line("margin-top: 16px;")
                .end("}")
                .line()
                .begin(".game-master .languages > a {")
                .line(cssDisplayInlineBlock)
                .line("width: 32px;")
                .line("height: 32px;")
                ...
                .end("}")
                .line()
                .begin(".game-master .languages > a.main {")
                ...
                .end("}")
                .line()
                .begin(".game-master .languages > a.semi {")
                ...
                .end("}")
                .line()
                .begin(".game-master .languages > a.rest {")
