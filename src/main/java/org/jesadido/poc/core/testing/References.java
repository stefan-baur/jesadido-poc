...
public final class References {
    ...
    public static final ConceptBook GAME_BOOK = new ConceptBook("Game Concepts")
            ...
            .add(new ConceptBookEntry("GigantA")
                    ...
                    .addDefaultTargets(new FrTarget("gigantesque", Fr.MASCULINE, Fr.FEMININE, Fr.PRE))
            )
            .add(new ConceptBookEntry("KarA")
                    ...
                    .addDefaultTargets(new FrTarget("cher", Fr.MASCULINE, Fr.PRE), new FrTarget("chère", Fr.FEMININE, Fr.PRE))
            )
